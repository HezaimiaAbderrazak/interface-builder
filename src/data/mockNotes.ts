...
export const mockNotes: Note[] = [
  {
    ...
    isArchived: false,
    tags: [
      { id: 't1', name: 'architecture', isAI: true },
      { id: 't2', name: 'microservices', isAI: true },
    ],
  ...
  },
  {
    ...
    isArchived: false,
    tags: [
      { id: 't3', name: 'meetings', isAI: false },
      { id: 't4', name: 'planning', isAI: true },
    ],
  ...
  },
  {
    ...
    isArchived: false,
    tags: [
      { id: 't5', name: 'security', isAI: true },
      { id: 't6', name: 'API', isAI: false },
      { id: 't7', name: 'authentication', isAI: true },
    ],
  ...
  },
  {
    ...
    isArchived: false,
    tags: [
      { id: 't8', name: 'design', isAI: true },
      { id: 't9', name: 'UI/UX', isAI: false },
    ],
  ...
  },
  {
    ...
    isArchived: false,
    tags: [
      { id: 't10', name: 'database', isAI: true },
      { id: 't11', name: 'SQL', isAI: false },
    ],
  ...
  },
  {
    ...
    isArchived: false,
    tags: [
      { id: 't12', name: 'books', isAI: false },
      { id: 't13', name: 'learning', isAI: true },
    ],
  ...
  },
  {
    ...
    content: 'Implement virtual scrolling for large note lists. Use Web Workers for embedding generation. Consider edge caching for frequently accessed notes. Lazy load the rich text editor.',
    color: 'pink',
    isPinned: false,
    isArchived: false,
    tags: [
      { id: 't14', name: 'performance', isAI: true },
      { id: 't15', name: 'optimization', isAI: true },
    ],
  ...
  },
  {
    ...
    isArchived: false,
    tags: [
      { id: 't16', name: 'idea', isAI: true },
    ],
    createdAt: '2026-04-05T22:00:00Z',
    updatedAt: '2026-04-05T22:00:00Z',
  },
  {
    id: '9',
    ...
    isArchived: false,
    tags: [
      { id: 't17', name: 'devops', isAI: true },
      { id: 't18', name: 'deployment', isAI: false },
    ],
